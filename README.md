...
5. **Dodge a huge gauntlet of hazards** — buildings, **spinning wind turbines**, **dropping boulders**, **sweeping rotating bars**, blinking **laser gates**, **wind-gust zones** that shove you sideways, swinging **wrecking-ball pendulums**, rising/falling **hot-air balloons**, darting **drones**, cranes, and bird flocks. Each zone has its own mix. Clipping anything crashes you (debris + slow-mo).
